...
1.  **Create a Gatsby site.**
    ...
    ```sh
    # create a new Gatsby site using theme europa
    gatsby new europa https://github.com/wpspark/gatsby-theme-europa.git
    ```
2.  **Create `.env` file.**
...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/wpspark/gatsby-theme-europa)
